...
$LimitingCollection = "Limiting: All Client Endpoints (Active Clients)"
...
If (!(Test-Path -Path "$($SiteCode.name):\DeviceCollection\Administrative\Limiting\Locations\Boundary"))
{
    #Create sub folder for Boundary groups collection
    new-item -Name 'Boundary Groups based collection' -Path $($SiteCode.Name+":\DeviceCollection\Administrative\Limiting\Locations\Boundary")
    #$FolderPath = $SiteCode.name+":\DeviceCollection\Boundary Groups based collection"
}

$FolderPath = $SiteCode.name+":\DeviceCollection\Administrative\Limiting\Locations\Boundary"
